...
const DrawingCanvasNA = ({chosenNumber}) => {
...
console.log(chosenNumber);
    try {
      ...
      const response = await fetch(
        "http://ec2-54-167-187-236.compute-1.amazonaws.com:4000/checkArabicNumbers",
        {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({ image: dataUrl, letter: chosenNumber }),
        }
      );
    ...
    // clearCanvas(); // Uncomment this line if you want to clear the canvas after capturing the image
  };
...
export default DrawingCanvasNA