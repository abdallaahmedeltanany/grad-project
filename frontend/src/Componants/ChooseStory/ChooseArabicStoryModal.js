...
const ChooseArabicStoryModal = (props) => {
                  ...
                  return (
                    <li
                      ...
                      onClick={() => {
                        ...
                        navigation("/arabicstorycontent", { state: datatoSend });
                      }}
                    >
                      <p className="story-name">{story.title}</p> <hr />
                    </li>
                  );
                })}
              </ul>
...
export default ChooseArabicStoryModal;
